...
[![Travis build status](https://travis-ci.org/dreamRs/gfonts.svg?branch=master)](https://travis-ci.org/dreamRs/gfonts)
[![Codecov test coverage](https://codecov.io/gh/dreamRs/gfonts/branch/master/graph/badge.svg)](https://codecov.io/gh/dreamRs/gfonts?branch=master)
<!-- badges: end -->

> Download 'Google' fonts (via [google-webfonts-helper](https://google-webfonts-helper.herokuapp.com/fonts)) and generate CSS to use in [rmarkdown](https://rmarkdown.rstudio.com/) documents and [shiny](https://shiny.rstudio.com/) applications. Some popular fonts are included and ready to use.
...
:point_right: [See detailled example](https://dreamrs.github.io/gfonts/articles/gfonts.html)
